...
const tickets: ResponderTicket[] = [
  {
    id: 'HR-INC-2401',
    title: 'Confidential employee concern – potential harassment',
    category: 'Human Incident',
    priority: 'High',
    status: 'In Progress',
    reporter: 'HR Partner (Caroline Polotto)',
    assignedResponder: 'HR Response Team',
    summary:
      'A confidential employee concern was raised regarding potentially inappropriate verbal behaviour occurring in a shared workspace. Matter requires prompt HR assessment and safeguarding measures.',
    details: [
      'Conduct an initial, confidential check-in with the reporting employee to clarify the nature of the concern without requesting sensitive details.',
      'Ensure the employee feels safe and understands the no-retaliation protections under the Speak Up Policy.',
      'Notify Group Head HR as required by the Speak Up and Code of Conduct frameworks.',
      'Coordinate with relevant internal functions (e.g., CRO office) for next procedural steps. Evidence handling or interviews must only be initiated by authorised HR investigators.',
      'Evaluate whether any interim workplace measures are needed to protect involved employees.',
    ],
    location: 'Gland HQ – SWE Open Space',
